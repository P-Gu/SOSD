...
#ifndef _GLOW_BUNDLE_NET_6_H
#define _GLOW_BUNDLE_NET_6_H
...
#define NET_6_net_input   0
#define NET_6_net_output  64

// Memory sizes (bytes).
#define NET_6_CONSTANT_MEM_SIZE     8896
#define NET_6_MUTABLE_MEM_SIZE      128
#define NET_6_ACTIVATIONS_MEM_SIZE  256

// Memory alignment (bytes).
#define NET_6_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int net_6(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
