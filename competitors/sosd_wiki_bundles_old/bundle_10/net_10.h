...
#ifndef _GLOW_BUNDLE_NET_10_H
#define _GLOW_BUNDLE_NET_10_H
...
#define NET_10_net_input   0
#define NET_10_net_output  64

// Memory sizes (bytes).
#define NET_10_CONSTANT_MEM_SIZE     8896
#define NET_10_MUTABLE_MEM_SIZE      128
#define NET_10_ACTIVATIONS_MEM_SIZE  256

// Memory alignment (bytes).
#define NET_10_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int net_10(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
