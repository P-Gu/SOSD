...
#ifndef _GLOW_BUNDLE_NET_1_H
#define _GLOW_BUNDLE_NET_1_H
...
#define NET_1_net_input   0
#define NET_1_net_output  64

// Memory sizes (bytes).
#define NET_1_CONSTANT_MEM_SIZE     8896
#define NET_1_MUTABLE_MEM_SIZE      128
#define NET_1_ACTIVATIONS_MEM_SIZE  256

// Memory alignment (bytes).
#define NET_1_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int net_1(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
